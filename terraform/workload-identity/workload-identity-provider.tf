...
#checkov:skip=CKV_GCP_118: description is intentionally omitted; display_name, attribute_condition, and attribute_mapping provide sufficient context for this internal bootstrap pool
